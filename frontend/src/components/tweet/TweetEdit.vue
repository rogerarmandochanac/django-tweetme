<template>
  <div class="container">
    <div class="row mt-3">
        <div class="col">
            <h1 class="text-start">Editar Libro</h1>
        </div>
        <div class="row">
            <div>
                <div class="card">
                        ...
                        <form action="" @submit="onSubmit">
                            ...
                            <div class="row mt-3">
                                <div class="col text-start">
                                    ...
                                    <input type="submit" value="Cancelar" class="btn btn-danger ms-2" :to="{name:'home'}">
                                </div>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods:{
        onSubmit(evt){
            ...
            axios.put(path, {content:this.form.content, user:1}).then((response)=>{
                this.form.content = response.data.content
                swal("Tweet actualizado exitosamente", "", "success")
